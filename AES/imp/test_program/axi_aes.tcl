...
#
# axi_aes.tcl: Tcl script for re-creating project 'axi_aes'
#
# Generated by Vivado on Sun Jun 12 15:31:04 -0300 2022
...
#
# 1. This project restoration tcl script (axi_aes.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/vivpt/axi_aes/axi_aes.srcs/sources_1/bd/aes_enc_dec_test/hdl/aes_enc_dec_test_wrapper.vhd"
#    "D:/vivpt/axi_aes/axi_aes.srcs/constrs_1/imports/ZedBoard/ZedBoard.xdc"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../axi_aes"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../../labs/ip_repo"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/../../../../axi_aes/axi_aes.srcs/sources_1/bd/aes_enc_dec_test/hdl/aes_enc_dec_test_wrapper.vhd" ]\
]
...
set file "hdl/aes_enc_dec_test_wrapper.vhd"
...
set_property -name "top" -value "aes_enc_dec_test_wrapper" -objects $obj
...
set file "[file normalize ${origin_dir}/../../../../axi_aes/axi_aes.srcs/constrs_1/imports/ZedBoard/ZedBoard.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "ZedBoard/ZedBoard.xdc"
...
# Proc to create BD aes_enc_dec_test
proc cr_bd_aes_enc_dec_test { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name aes_enc_dec_test
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:user:AXI_AES_DECODER:1.0\
  xilinx.com:user:AXI_AES_ENCODER:1.0\
  ...
  # Create instance: AXI_AES_DECODER_0, and set properties
  set AXI_AES_DECODER_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_AES_DECODER:1.0 AXI_AES_DECODER_0 ]

  # Create instance: AXI_AES_ENCODER_0, and set properties
  set AXI_AES_ENCODER_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_AES_ENCODER:1.0 AXI_AES_ENCODER_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AXI_AES_ENCODER_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins AXI_AES_DECODER_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AXI_AES_DECODER_0/s00_axi_aclk] [get_bd_pins AXI_AES_ENCODER_0/s00_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net reset_rtl_1 [get_bd_ports reset_rtl] [get_bd_pins clk_wiz_0/resetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXI_AES_DECODER_0/s00_axi_aresetn] [get_bd_pins AXI_AES_ENCODER_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_AES_DECODER_0/S00_AXI/S00_AXI_reg] SEG_AXI_AES_DECODER_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_AES_ENCODER_0/S00_AXI/S00_AXI_reg] SEG_AXI_AES_ENCODER_0_S00_AXI_reg
...
# End of cr_bd_aes_enc_dec_test()
cr_bd_aes_enc_dec_test ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files aes_enc_dec_test.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files aes_enc_dec_test.bd ] 
set_property IS_ENABLED "1" [get_files aes_enc_dec_test.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files aes_enc_dec_test.bd ] 
set_property IS_LOCKED "0" [get_files aes_enc_dec_test.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files aes_enc_dec_test.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files aes_enc_dec_test.bd ] 
set_property PFM_NAME "" [get_files aes_enc_dec_test.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files aes_enc_dec_test.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files aes_enc_dec_test.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files aes_enc_dec_test.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files aes_enc_dec_test.bd ] 
set_property USED_IN_SIMULATION "1" [get_files aes_enc_dec_test.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files aes_enc_dec_test.bd ] 
